...
const (
	Role_CreateRole_FullMethodName    = "/auth.v1.Role/CreateRole"
	Role_UpdateRole_FullMethodName    = "/auth.v1.Role/UpdateRole"
	Role_DeleteRole_FullMethodName    = "/auth.v1.Role/DeleteRole"
	Role_GetRole_FullMethodName       = "/auth.v1.Role/GetRole"
	Role_ListRole_FullMethodName      = "/auth.v1.Role/ListRole"
	Role_GrantUserRole_FullMethodName = "/auth.v1.Role/GrantUserRole"
)
...
func (c *roleClient) GrantUserRole(ctx context.Context, in *GrantUserRoleRequest, opts ...grpc.CallOption) (*GrantUserRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Role_GrantUserRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Role_GrantUserRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Role_GrantUserRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
