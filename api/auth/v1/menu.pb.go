...
var file_auth_v1_menu_proto_rawDesc = []byte{
	...
	0xe4, 0x93, 0x02, 0x0d, 0x3a, 0x01, 0x2a, 0x22, 0x08, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x65, 0x6e,
	0x75, 0x12, 0x4f, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x65, 0x6e, 0x75, 0x12, 0x18, 0x2e,
	...
	0x75, 0x73, 0x42, 0x18, 0x5a, 0x16, 0x77, 0x68, 0x79, 0x2d, 0x73, 0x79, 0x73, 0x2f, 0x61, 0x70,
...
var file_auth_v1_menu_proto_goTypes = []any{
...
func file_auth_v1_menu_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_auth_v1_menu_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_auth_v1_menu_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_auth_v1_menu_proto_msgTypes[2].Exporter = func(v any, i int) any {
